...
export default function HomePage() {
  ...
  return (
    <div style={{ minHeight: "100vh" }}>
      ...
      {/* Footer */}
      <footer style={{ textAlign: "center", padding: "24px", borderTop: "1px solid var(--color-border)", color: "var(--color-text-tertiary)", fontSize: "12px", letterSpacing: "0.01em" }}>
        GATEForge — Built with AI. Not affiliated with IIT or GATE organizing body.
      </footer>
    </div>
  );
}
